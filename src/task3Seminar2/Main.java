...
public class Main {
    ...
    1. Аннотации для маппинга:
        Создайте аннотации, такие как @Entity, @task3Seminar2.Table, @Column для маппинга классов,
    ...
    */
        public static void main(String[] args) throws IllegalAccessException {
                ...
                Employee user = new Employee("Stas", "stas@mail.com");
                ...
                String buildDeleteQuery = queryBuilder.buildDeleteQuery(Employee.class, pk);
